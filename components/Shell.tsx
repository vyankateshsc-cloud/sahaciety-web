...
export function Header() {
  return <><header className="site-header"><div className="container header-inner"><Logo /><nav className="desktop-nav" aria-label="Primary navigation"><Link href="/services">Services</Link><Link href="/schemes">Schemes</Link><Link href="/solutions">Solutions</Link><Link href="/about">About</Link><Link href="/knowledge">Knowledge</Link><Link href="/partners">Partners</Link></nav><div className="header-actions"><Link href="/login" className="login-link">Login</Link><Link href="/diagnostic" className="button button-small button-light">Get started <ArrowUpRight size={16} /></Link><MobileNav /></div></div></header><AskAssistant /><WhatsAppFab /></>;
}
