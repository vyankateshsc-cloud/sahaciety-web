...
export default function CategoryPage({ params }: { params: { category: string } }) { const category = getCategory(params.category); if (!category) notFound(); return <PageShell eyebrow="Services" title={category.title} intro={category.summary}><CategoryContent title={category.title} summary={category.summary} services={category.services} /></PageShell>; }